...
<tr>
	<td>
		<p>
 <img width="191" alt="wwww.png" src="/upload/medialibrary/5fb/5fbf0d6b0f7fbe70357f513dad7c45a5.png" height="191" v:shapes="Рисунок_x0020_4" title="wwww.png">
		</p>
	</td>
	<td>
		<ul type="disc">
...
После того как ваша анкета будет одобрена, вам
придет уведомление на ваш e-mail о начале сотрудничества. После этого вам нужно
подписать бумажный договор с нашей компанией. Вам потребуется заполнить
реквизиты, распечатать два экземпляра договора, подписать со своей стороны и
выслать на адрес нашей компании. Мы, со своей стороны, подпишем договор и&nbsp;<?require($_SERVER["DOCUMENT_ROOT"]."/bitrix/footer.php");?>